...
//console.log(process.env.DELAY_TIME);
//create openai object with api key
const openai = new OpenAI({
    apiKey: "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",//process.env.OPENAI_API_KEY,
...
fs.readFile(metroFile,'utf-8',async(err,data)=>{
    ...
    //     file: fs.createReadStream(foodBasicsFile),
    //     purpose: "assistants",
    // });
    ...
    setTimeout(async()=>{
        ...
        //lists all messages in current thread
        // message.body.data.forEach((m) => {
        //     console.log(m.content);
        //  });
